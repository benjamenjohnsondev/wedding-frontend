...
const RSVPFormClosed = (props) => {  
    ...
    return (
        <div className={styles.rsvpWrapperOuter} ref={rsvp}>
            ...
            <p>Meal options are now locked in!</p>
            <p>If you need to change anything, or want to check your choices - please let us know!</p>
            <p>Add your songs to our jukebox!</p>
